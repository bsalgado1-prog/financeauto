...
export default function App() {
  ...
  const opsVenc = [...opsAtivas].sort((a,b)=>(parseInt(a.dia_venc)||99)-(parseInt(b.dia_venc)||99));
  ...
  const sortOps = (ops, tipo) => {
    ...
    if(tipo==="dia") return sorted.sort((a,b)=>{const da=Number(String(a.dia_venc).trim())||99;const db=Number(String(b.dia_venc).trim())||99;if(da!==db)return da-db;return nomeTomador(a).localeCompare(nomeTomador(b));});
